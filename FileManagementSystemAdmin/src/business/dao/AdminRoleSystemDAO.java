...
public interface AdminRoleSystemDAO {
	 ...
	 */
	public List<VRoleSystemModel> getAdminRoleSystem(int currentPage, int pageSize);
	...
	* @param wherecondition 组合查询条件字符串,如："userRole = '超级管理员' and userid = 'zhangjs'" 
	 ...
	 * @return  List<VUser> 
	 */
	public List<VRoleSystemModel> getAdminRoleSystemByName(String wherecondition, int currentPage, int pageSize);
